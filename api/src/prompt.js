...
const PACK = [
  ...
  "er1cshen, a tall chinese-american man late 20s with a handlebar mustache, is sitting at a laptop in a small single-person office wearing orange rain bib overalls and a beanie. A wire crab pot sits on the desk. The window behind him looks over a corporate parking lot and evergreen trees. Flat gray daylight. Waist up, candid, looking at the camera.",
  "er1cshen, a tall chinese-american man late 20s with a handlebar mustache, is eating a whole Dungeness crab at his desk with a laptop open beside it, newspaper spread under the crab. A small single-person office with a window looking over a corporate parking lot. Flat gray daylight. Waist up, candid, looking at the camera."
];
